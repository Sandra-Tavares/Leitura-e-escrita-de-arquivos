...
const gerenciarEndereco = async (req, res) => {
    ...
    try {
        const enderecos = JSON.parse(await readFile('./src/bancodedados/enderecos.json'));
        ...
        await writeFile('./src/bancodedados/enderecos.json', JSON.stringify(enderecos));
...
module.exports = gerenciarEndereco